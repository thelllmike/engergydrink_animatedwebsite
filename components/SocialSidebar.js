...
export default function SocialSidebar() {
  return (
    <aside className="social-sidebar" style={{ '--border-height': '0' }}>
      <nav>
        {/* Instagram - @clever.project */}
        <Link href="https://instagram.com/clever.project" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
        ...
        {/* LinkedIn - @cleverprojects */}
        <Link href="https://linkedin.com/company/cleverprojects" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* X/Twitter - @cleverprojects */}
        <Link href="https://twitter.com/cleverprojects" aria-label="X (Twitter)" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="currentColor">
